 ...
 * - Автоматическое создание коллекции при старте
 */
@Service
...
public class TypeSenseService {
    ...
    public List<SearchResultDto> search(String query) {
        ...
        try {
            ...
            SearchResult result = typeSenseClient.collections(collection)
                    .documents()
    ...
    public boolean indexDocument(Document document) {
        ...
        try {
            ...
            typeSenseClient.collections(collection)
                    .documents()
                    .upsert(doc);
            ...
            log.warn("TypeSense error indexing document {}: {}", 
    ...
    public int batchIndexDocuments(Collection<Document> documents) {
        ...
        try {
            List<Map<String, Object>> docs = documents.stream()
                    .map(this::convertToTypeSenseDocument)
