 ...
 * RestHighLevelClient deprecated since OpenSearch 2.0
 * 
 * References:
...
public class OpenSearchConfig {
    ...
    public PoolingHttpClientConnectionManager openSearchConnectionManager() {
        ...
        log.info("OpenSearch connection pool configured: maxTotal={}, maxPerRoute={}", 
     ...
     */
    @Bean(destroyMethod = "close")
    public CloseableHttpClient openSearchHttpClient(PoolingHttpClientConnectionManager connectionManager) {
        ...
        log.info("OpenSearch HttpClient configured: connectionTimeout={}ms, socketTimeout={}ms", 
     ...
     */
    @Bean(destroyMethod = "close")
    @ConditionalOnProperty(name = "search.opensearch.enabled", havingValue = "true", matchIfMissing = true)
