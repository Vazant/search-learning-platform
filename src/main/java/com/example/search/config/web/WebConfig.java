...
/**
 * Конфигурация для обработки дат в REST API Поддерживает форматы: - ISO 8601: 2024-01-01T00:00:00 -
 * ISO 8601 с миллисекундами: 2025-11-10T18:11:16.046 - ISO 8601 с Z: 2025-11-10T18:11:16.046Z (UTC
 * timezone, Z игнорируется для LocalDateTime)
 */
@Configuration
public class WebConfig implements WebMvcConfigurer {
  ...
  /** Конвертер строки в LocalDateTime Поддерживает форматы с Z и без Z */
      ...
      try {
        ...
        try {
          ...
          throw new IllegalArgumentException(
              "Cannot parse date: " + source + ". Expected format: yyyy-MM-dd'T'HH:mm:ss[.SSS][Z]",
              e2);
        }
      }
    }
