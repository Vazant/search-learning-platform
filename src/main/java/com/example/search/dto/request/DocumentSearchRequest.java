...
public class DocumentSearchRequest {
    ...
    @Schema(
        description = "Фильтр по автору (LIKE поиск, без учета регистра)",
        example = "Алексей"
    )
    ...
    @Schema(description = "Номер страницы (0-based)", example = "0", minimum = "0", defaultValue = "0")
    @Min(0)
    private Integer page;
    
    @Schema(description = "Размер страницы", example = "20", minimum = "1", maximum = "100", defaultValue = "20")
    @Min(1)
    @Max(100)
    private Integer size;
    
    @Schema(description = "Поле для сортировки", example = "createdAt", allowableValues = {"title", "createdAt", "updatedAt", "author", "category", "status"})
    private String sortBy;
    
    @Schema(description = "Направление сортировки", example = "DESC", allowableValues = {"ASC", "DESC"}, defaultValue = "DESC")
