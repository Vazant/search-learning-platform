 ...
 *
 * <p>Используется для: - Проверки доступности поисковых движков - Мониторинга производительности -
 * Отслеживания медленных запросов - CI/CD health checks
 */
@RestController
...
public class SearchHealthController {
  ...
  public ResponseEntity<Map<String, Object>> checkSearchEngines() {
    ...
    health.put(
        ...
        Map.of(
            "status",
            solrHealthy ? DocumentConstants.HEALTH_STATUS_UP : DocumentConstants.HEALTH_STATUS_DOWN,
            "url",
    ...
    health.put(
        ...
        Map.of(
            "status",
            openSearchHealthy
                ? DocumentConstants.HEALTH_STATUS_UP
                : DocumentConstants.HEALTH_STATUS_DOWN,
            "url",
            "http://localhost:9200"));
    ...
    health.put(
        ...
        Map.of(
            ...
            allHealthy
                ? DocumentConstants.HEALTH_STATUS_UP
                : DocumentConstants.HEALTH_STATUS_DEGRADED,
            "message",
            allHealthy ? "All search engines are healthy" : "Some search engines are unavailable"));
  ...
  public ResponseEntity<Map<String, Object>> getMetrics() {
    ...
    metrics.put(
        ...
        Map.of(
            "averageDuration",
            metricsService.getAverageDuration("search"),
            "requestCount",
            metricsService.getRequestCount("search"),
            "slowQueryCount",
            metricsService.getSlowQueryCount("search")));
    ...
    metrics.put(
        ...
        Map.of(
            "averageDuration",
            metricsService.getAverageDuration("autocomplete"),
            "requestCount",
            metricsService.getRequestCount("autocomplete"),
            "slowQueryCount",
            metricsService.getSlowQueryCount("autocomplete")));
    ...
    metrics.put(
        ...
        Map.of(
            "averageDuration",
            metricsService.getAverageDuration("facets"),
            "requestCount",
            metricsService.getRequestCount("facets"),
            "slowQueryCount",
            metricsService.getSlowQueryCount("facets")));
  ...
  public ResponseEntity<Map<String, Object>> getGraphQLStats() {
    ...
    operations.put(
        ...
        Map.of(
            "averageDuration",
            metricsService.getAverageDuration("searchDocuments"),
            "requestCount",
            metricsService.getRequestCount("searchDocuments"),
            "slowQueryCount",
            metricsService.getSlowQueryCount("searchDocuments")));
    operations.put(
        "autocomplete",
        Map.of(
            "averageDuration",
    ...
    stats.put(
        ...
        Map.of(
            "message",
            "Check logs for 'CACHE CANDIDATE' messages. Hot queries are logged automatically every minute.",
            "howToUse",
            "Look for log messages with '🔥 CACHE CANDIDATE' prefix. These queries should be cached."));
